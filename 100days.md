...
<div class="wrapper">
  <div class="intro-text">
    ...
    <p>Read why I started <a href="http://jessecrow.com/2015/07/22/starting-100-days.html">here</a>.</p>
  </div>
  <div class="day">
    <h2>Day 100</h2>
  ...
  <div class="day">
    <h2>Day 77</h2>
    <h3>October 11, 2015</h3>
    <img src="../img/100days/day77-projectredesign.jpg" class="day-image" alt="redesign of a project page">
  </div>
  <div class="day">
    <h2>Day 76</h2>
    <h3>October 10, 2015</h3>
    <img src="../img/100days/day76-blogredesign.jpg" class="day-image" alt="redesign of my blog index page">
    <p>Uh oh, I caught the portfolio redesign bug.</p>
  </div>
  <div class="day">
    <h2>Day 75</h2>
  ...
  <div class="day">
    ...
    <p>Trying to usher in fall with sautéed kale and apple with EVOO, apple cider vinegar, salt, pepper, and veggie bacon.</p>
  </div>
  <div class="day">
    <h2>Day 64</h2>
    <h3>September 28, 2015</h3>
    <img src="../img/100days/day64-watercolors.jpg" class="day-image" alt="playing with bluebonnets and succulents with watercolors">
  </div>
  <div class="day">
    <h2>Day 63</h2>
    <h3>September 27, 2015</h3>
    <img src="../img/100days/day63-guitar.png" class="day-image" alt="guitar icon">
  </div>
  <div class="day">
    <h2>Day 62</h2>
  ...
  <div class="day">
    <h2>Day 55</h2>
    <h3>September 19, 2015</h3>
    <img src="../img/100days/day55-arrowcatcher.jpg" class="day-image" alt="swiss design style show poster">
  </div>
  <div class="day">
    <h2>Day 54</h2>
  ...
  <div class="day">
    <h2>A Hiatus</h2>
    <p>In pursuit of a huge opportunity. Realizing that I'm human and can't stretch myself too thin so that's where I'll be focusing my energy for the next week. I'll be back to this project soon!</p>
  </div>
  <div class="day">
    <h2>Day 49</h2>
  ...
  <div class="day">
    ...
    <img src="../img/100days/day40-austintx.jpg" class="day-image" alt="handlettered austin">
    <p>Practice practice practice practice. Not there yet, but better than I was.</p>
  </div>
  <div class="day">
    <h2>Day 39</h2>
  ...
  <div class="day">
    ...
    <img src="../img/100days/day34-x.jpg" class="day-image" alt="a blue and red x">
  </div>
  <div class="day">
    <h2>Day 33</h2>
    <h3>August 22, 2015</h3>
    <p>Made <a href="http://minimalistbaker.com/no-bake-lemon-cookie-fruit-tarts/">this</a> tart tonight—didn't last long enough for a photo.</p>
  </div>
  <div class="day">
    <h2>Day 32</h2>
